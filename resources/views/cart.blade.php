                ...
                <tr id="row-{{ $id }}">
                    ...
                    <td>
                        @php
                            ...
                            $cartImageUrl = $cartImage
                                ? ((str_starts_with($cartImage, 'http://') || str_starts_with($cartImage, 'https://')) ? $cartImage : asset($cartImage))
                                : 'https://via.placeholder.com/50x50?text=No+Image';
                        @endphp
                        <img src="{{ $cartImageUrl }}" width="50" height="50" class="rounded me-2">
                        {{ $details['name'] }}
                    </td>
