...
@section('content')
    <div class="mb-6 rounded-2xl border border-red-200 bg-gradient-to-r from-red-600 via-rose-600 to-orange-500 p-6 shadow-lg">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <a href="{{ url('/admin/products/create') }}" class="inline-flex items-center justify-center rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-sm transition hover:bg-rose-50">
                + Add Product
            </a>
        </div>
    </div>
                        ...
                        <tr class="group transition hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 text-center">
                                @if($product->discount_percent > 0)
                                    <span class="rounded-full bg-amber-100 px-2 py-1 text-[10px] font-bold uppercase tracking-tight text-amber-700">
                            ...
                            <td class="px-4 py-3">
                                <span class="rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-tight {{ $product->availability === 'available' ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700' }}">
